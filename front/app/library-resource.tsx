...
const styles = StyleSheet.create({
  ...
  heroImage: { width: '100%', height: 160, maxHeight: 220, backgroundColor: '#f8fafc' },
  ...
  tag: { backgroundColor: '#f1f5f9', borderRadius: 8, borderWidth: 1, borderColor: '#e2e8f0', paddingHorizontal: 10, paddingVertical: 4, marginRight: 8, marginBottom: 6 },
